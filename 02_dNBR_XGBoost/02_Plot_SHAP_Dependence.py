...
def main() -> None:
    ...
    for biome in biomes:
        ...
        fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(2.6, 2.375))
        plt.subplots_adjust(left=0.145, right=0.99, top=0.99, bottom=0.12,
                            hspace=0.3625, wspace=0.375)
        ...
        save_path = os.path.join(biome_dir, "trend_lines_PAs_vs_nonPAs_2x2.png")
